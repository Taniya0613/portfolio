...
I’m always excited to collaborate, build innovative web applications 💻, and create digital solutions that make a real impact."
            </span>
          </div>
          <div className="contact-list">
            ...
            >
              ...
              <a href="tel:+917973437559">+91 7973437559</a>
            </motion.div>
            <motion.div
              className="contact-item"
              whileHover={{ scale: 1.08, backgroundColor: "#e3f2fd" }}
